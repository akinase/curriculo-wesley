...
class Artigos2007 extends StatelessWidget {
  ...
  List<Map<String, String>> publi2007 = [
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Mapeamento e distribuição por classe de relevo da cultura cafeeira em uma área piloto no município de Três Pontas MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Sistema de Informação Geográfica para realização de consultas a dados relacionados a cafeicultura de Minas Gerais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Modelagem pedomorfogeológica para o mapeamento de solos. Informe Agropecuário. Geotecnologias.pdf',
      'referencial':
    ...
    {
      'PDF':
          'Evaluation of land use and correlations with soil quality and water quality in Descoberto River watershed, Distrito Federal, Brazil. In: INTERNATIONAL GEOSCIENCEAND REMOTE SENSING SYMPOSIUM, 2007, Barcelona.',
      'path': '',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Zoneamento agroclimático - um estudo de caso para o café. Informe Agropecuário. Geotecnologias.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Levantamento e mapeamento espaço-temporal dos cafezais no município mineiro de Machado.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Sistema de Informação Geográfica para a Cafeicultura do Sul de Minas.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Sensoriamento remoto para a caracterização do ambiente cafeeiro das cidades - Arceburgo, Monte Santo de Minas, Guaxupé e Guaranésia, MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Avaliação  da acuracia dos classificadores Bathacahrya e Isoseg para o mapeamento de café.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Utilização do sensoriamento remoto para a caracterização do ambiente cafeeiro da região de Guaxupé, MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Exatidão de classificações automáticas de uma imagem Landsat 5 TM para a região cafeeira de Machado, MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Identificação e avaliação de estratégias de desenvolvimento territorial em áreas de cafeicultura familiar do sul de Minas Gerais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Informações e dados geográficos - compartilhamento e disponibilização. Informe Agropecuário. Geotecnologias.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Portal GEOSOLOS - web na divulgação mapas de caracterização ambiental em lavouras cafeeiras de Minas Gerais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Geothecnologies in the assessment of land use changes in coffee regions of the state of Minas Gerais in Brasil. Coffee Science,.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Estruturação, modelagem e implantação do banco de dados geográfico para cafeicultura do Sul de Minas.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'curriculo-wesley/curriculo/assets/publicacoes/2007/Sistema de geoinformação para a cafeicultura do Sul de Minas. Informe Agropecuário. Geotecnologias.pdf',
      'referencial':
