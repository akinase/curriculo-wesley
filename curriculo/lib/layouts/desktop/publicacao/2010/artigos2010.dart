  ...
  List<Map<String, String>> publi2010 = [
    {
      ...
      'path':
          '/assets/publicacoes/2010/Aplicação de Redes Neurais Artificiais (RNA) na análise e classificação de áreas cafeeiras da região de Machado-MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          '/assets/publicacoes/2010/Aplicação de Redes Neurais Artificiais (RNA) na análise e classificação de áreas cafeeiras em imagens de satélite.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          '/assets/publicacoes/2010/Identificação automática de áreas cafeeiras em imagens de satélite utilizando Redes Neurais Artificiais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          '/assets/publicacoes/2010/Spatial distribution of coffees from Minas Gerais state and their relation with quality. Coffee Science, Lavras.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          '/assets/publicacoes/2010/Índice de vegetação espectral e sua relação com a estiagem agrícola em áreas cafeeiras no município de Três Pontas, MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          '/assets/publicacoes/2010/Mapeamento de áreas cafeeiras (Coffeea Arabica L.) da Zona da Mata mineira usando sensoriamento remoto. Coffee Science,Lavras.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          '/assets/publicacoes/2010/Redes Neurais Artificiais (RNA) para identificação de áreas cafeeiras em imagens de satélite - treinamento e definição de arquiteturas.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          '/assets/publicacoes/2010/Evolução de áreas cafeeiras na paisagem do município de Três Pontas entre os anos de 1987 e 2007.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          '/assets/publicacoes/2010/Estudo espaço-temporal do uso da terra em áreas de Preservação Permanente na região de Três Pontas-MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          '/assets/publicacoes/2010/Turismo do café - setor promissor para agricultura familiar do Sul de Minas Gerais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          '/assets/publicacoes/2010/Estudo espaço-temporal da cafeicultura na região de São Sebastião do Paraíso-MG, utilizando geotecnologias.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          '/assets/publicacoes/2010/Estudo da evolução da cafeicultura na região de São Sebastião do Paraíso-MG, utilizando geotecnologias.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          '/assets/publicacoes/2010/Análise do comportamento da temperatura do ar em áreas cafeeiras arborizadas e a pleno sol em São Sebastião do Paraíso, MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          '/assets/publicacoes/2010/Monitoramento do Índice de Vegetação Espectral de áreas cafeeiras e sua relação com a precipitação no município de Três Pontas, Minas Gerais.pdf',
      'referencial':
