...
class Artigos2006 extends StatelessWidget {
  ...
  List<Map<String, String>> publi2006 = [
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2006/Monitoring the relationships between environment and coffee production in agroecosystems of the state of Minas Gerais In Brazil.pdf',
      'referencial':
