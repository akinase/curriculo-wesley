  ...
  List<Map<String, String>> publi2009 = [
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Influencia do relevo no mapeamento automático do café.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Sistema de informação geográfica na análise espaço-temporal do parque cafeeiro da região de Machado - MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Redes Neurais Artificiais na classificação de áreas cafeeiras da região de Guaxupé.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Redes Neurais Artificiais na classificação de áreas cafeeiras do Sul de Minas Gerais em imagem de satélite.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Cafés de qualidade do estado de Minas Gerais e sua relação com os fatores climáticos.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Distribuição espacial de cafés do concurso de qualidade Cafés de Minas - 2008.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Fatores climáticos e a espacialização dos cafés do estado de Minas Gerais e sua relação com a qualidade da bebida.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Mapeamento de áreas cafeeiras da região de Guaxupé por classificação automática utilizando Redes Neurais Artificiais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Levantamento e mapeamento espaço temporal dos cafezais no município mineiro de Machado. Caminhos de Geografia, Uberlândia.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Classificação de áreas cafeeiras por meio de Redes Neurais Artificiais e os aspectos relacionados à reflectância - um estudo exploratório.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Influência do declive na exatidão do classificador MAXVER para o mapeamento da cultura do café.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Variação temporal do índice de vegetação de lavouras cafeeiras utilizando produtos do sensor MODIS-TERRA.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Influência do declive na classificação automática da cultura cafeeira.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Monitoramento do NDVI de lavouras cafeeiras por meio de imagens MODIS.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Avaliação da acurácia do mapeamento de regiões cafeeiras por meio do índice Global e Kappa.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Mapeamento de áreas cafeeiras do Sul de Minas Gerais Machado e Três Pontas.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Mapeamento de áreas cafeeiras do Sul de Minas Gerais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Turismo rural - alternativa de melhoria para a cafeicultura familiar do Sul de Minas Gerais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Análise e classificação textural de áreas de mata e café na região de Machado - MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Análise espaço-temporal da cafeicultura mineira 1990-2009.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Espacialização da ocupação da cafeicultura nos municípios de Minas Gerais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Mapeamento de áreas cafeeiras utilizando Redes Neurais Artificiais - Estudo de caso na região de Três Pontas, Minas Gerais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Ambiente cafeeiro de Machado - mapeamento do uso da terra e relações tempo-espaço.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Mudanças no parque cafeeiro da região de Machado MG, 2000-2007 - estudo espaço-temporal.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Análise espacial do parque cafeeiro da região de Três Pontas MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Avaliação de classificadores automáticos no mapeamento de áreas cafeeiras da região de Guaxupé, Minas Gerais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Dinâmica espaço-temporal do parque cafeeiro da região de Três Pontas - MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Geotecnologias para estudo da evolução do parque cafeeiro de São Sebastião do Paraíso entre os anos 2000 e 2009.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Potencial do índice NDVI para o monitoramento agrometeorológico em área cafeeira do cerrado mineiro.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Imagens MODIS para determinação de estiagem agrícola em área cafeeira no município de Patrocínio, MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/Determinação de estiagem em áreas cafeeiras no município de Patrocínio, MG, utilizando imagens MODIS-TERRA.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2009/NDVI do produto MOD13Q1 e sua relação com a pluviosidade acumulada, em áreas cafeeiras de Três Pontas, MG.pdf',
      'referencial':
