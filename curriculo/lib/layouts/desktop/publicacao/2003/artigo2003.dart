  ...
  List<Map<String, String>> publi2003 = [
    {
      ...
      'path':
          'arquivos/publicacoes/2003/Avaliação das terras e sua importância para o planejamento racional do uso.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2003/Caracterização de agroecossistemas cafeeiros nas principais regiões produtoras do estado de Minas Gerais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2003/Caracterização da cultura cafeeira  em relação as classes de solos e declividade utilizando técnicas de geoprocessamento na região de São Sebastião do Paraíso-MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2003/Mapeamento das classes de solos da região de Machado-MG a partir da correlação entre solos e relevo, utilizando técnicas de geoprocessamento.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2003/Parâmetros culturais para avaliação do comportamento espectral da cultura do café em Minas Gerais.pdf',
      'referencial':
