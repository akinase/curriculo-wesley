  ...
  List<Map<String, String>> publi2012 = [
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Mineração de Dados Espectrais e Climáticos para Modelagem de Ocorrência de Cercospora em Cafeeiros.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Spatial distribution of coffees from Minas Gerais state and their relation with quality.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Utilização de técnicas de geoprocessamento como ferramenta para delimitação de áreas de preservação permanente no município de Brasópolis – MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Mapeamento da áreas de preservação permanente do munícipio de Cachoeira de Minas utilizando geotecnologias..pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Potential use of stable isotopes as an indicator of coffee quality.pdf',
      'referencial':
    ...
    {
      'PDF':
          'Coffee quality and its interactions with environmental factors in Minas Gerais, Brazil. Journal of Agricultural Science, v. 4.',
      'path': '',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Identification of areas for permanent preservation in coffee producing regions of south Minas Gerais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Caracterização da temperatura do ar e precipitação em áreas cafeeiras na região da Serra da Mantiqueira de Minas Gerais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Classificação pixel a pixel de cultivos cafeeiros em imagem de satélite de alta resolução.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Classificação pixel a pixel supervisionada em imagem de satélite – São Sebastião do Paraíso, MG.pdf',
      'referencial':
    ...
    {
      'PDF':
          'Classificação supervisionada de imagens de satélite para mapeamento de áreas cafeeiras: estudos das regiões de Três Pontas e São Sebastião do Paraíso - MG. In: SEMINÁRIO DE INICIAÇÃO CIENTÍFICA E TECNOLÓGICA DA EPAMIG/FAPEMIG, 9.',
      'path':
          'arquivos/publicacoes/2012/Classificação supervisionada de imagens de satélite para mapeamento de áreas cafeeiras - estudos das regiões de Três Pontas e São Sebastião do Paraíso - MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Estimativa da área de produção de café na região de Três Pontas Utilizando imagem de satélite Rapideye.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Uso de imagens de satélite Rapideye associado com classificação orientada a objetos para mapeamento de café.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Caracterização climática do município de Soledade de Minas na região da Serra da Mantiqueira de Minas Gerias visando qualidade para a bebida de cafeeiras.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Mapping of coffee lands by remote sensing.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Mapeamento de áreas cafeeiras utilizando técnicas de sensoriamento remoto - Estudo do município de Carmo de Minas (MG).pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Qualidade de sementes de café produzidas na fazenda experimental da EPAMIG em Três Pontas-MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Classificação automática de áreas cafeeiras em imagens de satélite, utilizando Redes Neurais Artificiais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Sistema de Informações Geográficas na integração do conhecimento científico e tecnológico da cafeicultura em Minas Gerais.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Classificação de imagens Rapideye para áreas cafeeiras no município de Campanha - MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Mapeamento de áreas cafeeiras por classificação automática utilizando imagens Rapideye para o município de Campanha-MG.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Qualidade de sementes de café produzidas pela EPAMIG em São Sebastião do Paraíso.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Utilizacao de tecnicas de sensoriamento remoto e geoprocessamento como subsidio para analise das areas de preservacao permanente do municipio de Olimpio Noronha.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Mapping of areas for permanent preservation in coffee producing regions of south Minas Gerais, Brazil and identification of land use conflicts.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Environmental characterization of coffee in the environmental protection area of Coqueiral, southern region of the State Minas Gerais, Brazil.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Applied data mining to modeling the occurrence of brown eye spot (Cercospora coffeicola Berkeley & Cooke) Coffee Tree.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Espacialização e dinâmica da cafeicultura mineira entre 1990 e 2008, utilizando técnicas de geoprocessamento.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Evolution in time and space of coffee production in the region of São Sebastião do Paraíso, Minas Gerais State, Brazil..pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/The relation between coffee phenology, rainfall and temperature in coffee lands in the Serra da Mantiqueira region, Minas Gerais State, Brazil.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2012/Relationship between coffee and environmental preservation in the Serra da Mantiqueira, Minas Gerais, Brazil.pdf',
      'referencial':
                                ...
                                children: [
                                  ...
                                  TextField(
                                    controller: TextEditingController(
                                        text: publi2012[index]['referencial']),
                                    readOnly: true,
