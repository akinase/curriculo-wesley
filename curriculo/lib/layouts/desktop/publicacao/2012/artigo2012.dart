...
class Artigos2012 extends StatelessWidget {
  ...
  List<Map<String, String>> publi2012 = [
    ...
    },
    {
      ...
      'path':
          'curriculo/assets/publicacoes/2012/Classificação supervisionada de imagens de satélite para mapeamento de áreas cafeeiras - estudos das regiões de Três Pontas e São Sebastião do Paraíso - MG.pdf',
      'referencial':
