  ...
  List<Map<String, String>> publi2002 = [
    {
      ...
      'path':
          'arquivos/publicacoes/2002/caracterizacao_ambiental_de_areas_de-cafe_do_cerrado_mineiro.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2002/caracterizacao_de_agroecossistemas_cafeeiros_do_sul_de_minas_por_meio_de_sig_para_fins_de_monitoramento_e_planejamento_sustentavel.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2002/identificacao_de_areas_ocupadas_pela_cafeicultura_nas_principais_regioes_produtoras_de_minas_gerais_utilizando_tecnicas_de_geoprocessamento.pdf',
      'referencial':
