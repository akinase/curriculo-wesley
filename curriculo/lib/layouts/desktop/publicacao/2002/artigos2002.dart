  ...
  List<Map<String, String>> publi2002 = [
    {
      ...
      'path':
          'arquivos/publicacoes/2002/Caracterização ambiental de áreas de café do cerrado mineiro.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2002/Caracterização de agroecossistemas cafeeiros do Sul de Minas por meio de SIG para fins de monitoramento e planejamento sustentável.pdf',
      'referencial':
    ...
    },
    {
      ...
      'path':
          'arquivos/publicacoes/2002/Identificação de áreas ocupadas pela cafeicultura nas principais regiões produtoras de Minas Gerais utilizando-se técnicas de geoprocessamento.pdf',
      'referencial':
