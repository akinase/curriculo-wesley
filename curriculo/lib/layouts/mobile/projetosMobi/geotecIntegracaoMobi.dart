...
class GeotecIntegracaoMobi extends StatefulWidget {
  const GeotecIntegracaoMobi({Key? key}) : super(key: key);

  @override
// ignore: library_private_types_in_public_api
  _GeotecIntegracaoMobiState createState() => _GeotecIntegracaoMobiState();
}

class _GeotecIntegracaoMobiState extends State<GeotecIntegracaoMobi>
